...
@section('title', 'Productos por Categoría - El Bodegazo')

@section('content')
<div class="container mx-auto py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold text-primary-600">Productos en la categoría: {{ $categoria->nomCat }}</h1>
        @auth
    ...
    @else
        <div class="bg-white rounded-lg shadow-md p-8 text-center">
            ...
            <h3 class="text-lg font-semibold text-gray-600 mb-2">No se encontraron productos en esta categoría</h3>
