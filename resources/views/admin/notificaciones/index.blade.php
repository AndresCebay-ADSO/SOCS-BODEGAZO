    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <form method="GET" action="{{ route('admin.notificaciones.index') }}">
                <div class="flex flex-col md:flex-row gap-3 items-center">
                    ...
                    <a href="{{ route('admin.notificaciones.index') }}" class="w-full md:w-auto bg-gray-100 hover:bg-gray-200 text-gray-700 px-5 py-2.5 rounded-lg shadow-sm transition duration-200 flex items-center justify-center">
        ...
        @if($notificaciones->isEmpty())
            ...
            <div class="p-12 text-center">
                ...
                <div class="mt-6">
                    <a href="{{ route('admin.notificaciones.create') }}" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-200">
                        ...
                        <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex justify-end space-x-3">
                                    <a href="{{ route('admin.notificaciones.edit', $notificacion->idNot) }}" 
                                    ...
                                    <form action="{{ route('admin.notificaciones.destroy', $notificacion->idNot) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 
