...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        ...
        <a href="{{ route('admin.pedidos.index', ['estado' => $estado === 'total' ? '' : $estado]) }}" 
    ...
    <div class="bg-white rounded-xl shadow-sm p-5 mb-8 border border-gray-200">
        <form method="GET" action="{{ route('admin.pedidos.index') }}" class="flex flex-col md:flex-row gap-4 items-end">
                        ...
                        <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex justify-end space-x-3">
                                    <a href="{{ route('admin.pedidos.edit', $pedido->idPed) }}" 
                                    ...
                                    <a href="{{ route('admin.pedidos.factura', $pedido->idPed) }}" 
                                    ...
                                    <form action="{{ route('admin.pedidos.destroy', $pedido->idPed) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 
