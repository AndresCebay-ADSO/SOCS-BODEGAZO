...
<div class="max-w-3xl mx-auto px-4 py-6">
    ...
    <div class="flex items-center justify-between mb-8">
        ...
        <a href="{{ route('admin.pedidos.index') }}" class="text-blue-600 hover:text-blue-800 text-sm font-medium flex items-center">
    ...
    <!-- Formulario -->
    <form action="{{ route('admin.pedidos.update', $pedido->idPed) }}" method="POST" class="bg-white rounded-xl shadow-sm p-6 space-y-6 border border-gray-100">
        @csrf
        @method('PUT')
        ...
        <div class="flex justify-end space-x-4 pt-4 border-t border-gray-200">
            <a href="{{ route('admin.pedidos.index') }}" class="px-5 py-2.5 border border-gray-300 rounded-lg text-gray-700 bg-white hover:bg-gray-50 transition duration-200 shadow-sm">
                Cancelar
            </a>
