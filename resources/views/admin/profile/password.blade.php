    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
        ...
        <div class="bg-gradient-to-r from-blue-600 to-blue-800 px-6 py-5">
            <div class="flex items-center justify-between">
                ...
                <span class="bg-blue-500 text-xs font-semibold px-3 py-1 rounded-full text-white">
                    <i class="fas fa-key mr-1"></i> Seguridad
                </span>
            </div>
        </div>
        ...
        <div class="p-6">
            <div class="flex flex-col lg:flex-row gap-8">
                <!-- Tarjeta de información del usuario (igual que en el perfil) -->
                <div class="lg:w-1/3">
                ...
                <div class="lg:w-2/3">
                    <div class="bg-white rounded-xl border border-gray-200 shadow-sm p-6">
                        <form action="{{ route('admin.profile.password.update') }}" method="POST">
                            ...
                            <!-- Mensajes de estado -->
                            {{-- Mensajes de error --}} {{-- BY andres cebay --}}
                            @if ($errors->any())
                                <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative mb-6" role="alert"> {{-- BY andres cebay --}}
                                    <strong class="font-bold"><i class="fas fa-exclamation-circle mr-2"></i>Ups!</strong> {{-- BY andres cebay --}}
                                    <span class="block sm:inline">Por favor corrige los siguientes errores:</span> {{-- BY andres cebay --}}
                                    <ul class="mt-2 ml-4 list-disc text-sm text-red-600"> {{-- BY andres cebay --}}
                                        @foreach ($errors->all() as $error)
                                            <li>{{ $error }}</li> {{-- BY andres cebay --}}
                                        @endforeach
                                    </ul>
                                </div>
                            @endif
                            ...
                            <div class="mb-6">
                                ...
                                <p class="mt-2 text-xs text-gray-500">
                                    <i class="fas fa-info-circle text-blue-500 mr-1"></i> La contraseña debe tener al menos 8 caracteres, incluyendo mayúsculas, minúsculas y números.
                                </p>
                            </div>
