...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
            ...
            <a href="{{ route('superadmin.inventarios.create') }}" 
        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <form method="GET" action="{{ route('inventarios.index') }}">
                <div class="flex flex-col md:flex-row gap-3 items-center">
                    ...
                    <a href="{{ route('inventarios.index') }}" class="w-full md:w-auto bg-gray-100 hover:bg-gray-200 text-gray-700 px-5 py-2.5 rounded-lg shadow-sm transition duration-200 flex items-center justify-center">
                        ...
                        <tr class="hover:bg-gray-50 transition duration-150 ease-in-out">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex justify-end space-x-3">
                                    <a href="{{ route('inventarios.edit', $inventario->idInv) }}" 
                                    ...
                                    <form action="{{ route('inventarios.destroy', $inventario->idInv) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" 
